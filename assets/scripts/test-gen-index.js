...
const page = renderPermalinkPage(template, posts[0], undefined, posts[1]);
...
const firstOutputs = expectedOutputs(template, posts);
const secondOutputs = expectedOutputs(template, posts);
